models = {
    ...
    "adapt_exp": {"name": "Adaptive expectations", "fields": ["Demand shift", "Demand slope", "Supply shift", "Supply slope", "Adaptation coefficient", "Periods", "Start price"]},
    "normal_price": {"name": "Expected price", "fields": ["Demand shift", "Demand slope", "Supply shift", "Supply slope", "Adjustment factor", "Periods", "Start price"]},
}
...
models_sk = {
    ...
    "adapt_exp": {"name": "Adaptívne očakávania", "fields": ["Posun dopytu","Sklon dopytu", "Posun ponuky", "Sklon ponuky", "Adaptačný koeficient", "Obdobie", "Počiatočná cena"]},
    "normal_price": {"name": "Očakávaná cena", "fields": ["Posun dopytu","Sklon dopytu", "Posun ponuky", "Sklon ponuky", "Faktor úpravy", "Obdobie", "Počiatočná cena"]},
}